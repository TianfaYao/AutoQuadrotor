...
/* Include files */
#include "_coder_Height_KF_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]H:/matlab_2014/Learing_Matlab/EKF_Kalman/data/attitude/ekf/Height_KF.m"),
                "context", 0);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("Height_KF"));
...
/*
 * File trailer for _coder_Height_KF_info.c
 *
 * [EOF]
 */
